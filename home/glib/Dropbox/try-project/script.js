...
/* harmony import */ var _modules_works__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/works */ "./src/js/modules/works.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.decoration_slider', '.no_click', '[decoration-content]', 'after_click');
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_2__["default"])('.glazing_slider', '.glazing_block', '.glazing_content', 'active');
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_works__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
...
function forms() {
  ...
  function validateForm(form) {
    var input = form.querySelector('input[name="user_phone"]');
  ...
  function showThanksModal(message) {
    var prevModalDialog = document.querySelector('.show');

    if (prevModalDialog) {
      Object(_modals__WEBPACK_IMPORTED_MODULE_6__["hideModal"])('.show');
    }

    var modalDialog = document.querySelector('.popup_dialog');
    modalDialog.classList.add('hide');
    Object(_modals__WEBPACK_IMPORTED_MODULE_6__["showModal"])('.popup');
    var thanksModal = document.createElement('div');
    thanksModal.classList.add('popup_dialog');
    thanksModal.innerHTML = "\n            <div class=\"popup_content text-center\">\n                <button type=\"button\" class=\"popup_close\"><strong>&times;</strong></button>\n                <div class=\"popup_form\">\n                    <form class=\"form\" action=\"#\">\n                        <h2><span>".concat(message, "</span></h2>\n                    </form>\n                </div>\n            </div>\n        ");
    document.querySelector('.popup').append(thanksModal);
    setTimeout(function () {
      thanksModal.remove();
      modalDialog.classList.remove('hide');
      Object(_modals__WEBPACK_IMPORTED_MODULE_6__["hideModal"])('.popup');
    }, 2000);
  }
  ...
  forms.forEach(function (form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["default"])(' http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
...
function modals() {
  function bindModalBtn(openSelector, modalSelector, closeSelector) {
...
function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    ...
    if (target.classList.contains(tabSelector.replace('.', '')) || target.parentElement.classList.contains(tabSelector.replace('.', ''))) {
...
function timer() {
  ...
  function countRemainingTime(deadline) {
    ...
    var seconds = parseInt(Math.floor((deadline - currentDate) / 1000 % 60)),
  ...
  function pushTimer(deadline) {
    var time = countRemainingTime(deadline);
    var timer = document.querySelectorAll('.container1 span');
...
function works() {
  var images = document.querySelectorAll('.works img');
